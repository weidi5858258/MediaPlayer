...
public class ControlService extends DlnaService implements DeviceChangeListener,
    ...
    public static final String RESET_SEARCH_DEVICES = "com.geniusgithub.allshare" +
            ".reset_search_device";
