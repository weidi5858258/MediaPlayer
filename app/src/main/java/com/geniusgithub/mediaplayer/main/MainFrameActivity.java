    ...
    private class MainFragmentAdapter extends FragmentPagerAdapter {
     ...
     class MainView implements  MainContract.IView, IToolBar, MainNavigationView.INavClickListener{
        ...
        public void setupView(View rootView) {
            ...
            mDrawerLayout = (DrawerLayout)mRootView.findViewById(R.id.dl_main_drawer);
            mTabLayout = (TabLayout)mRootView.findViewById(R.id.tabs);
            mViewPager = (ViewPager)mRootView.findViewById(R.id.viewpager);
            mNavigationView = (MainNavigationView)mRootView.findViewById(R.id.nv_main_navigation);
            initToolBar();
            initDrawLayout();
            setupViewPager();
        }
